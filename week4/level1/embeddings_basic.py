...
sentences = [
    "Deep learning models tune millions of weights to improve prediction accuracy.",
    "Deep diving requires huge amounts of training and lung capacity.",
    "Baking a pie from scratch needs fresh ingredients and careful timing.",
    "Raspberry Pi computers are popular for DIY electronics projects.",
    "The new rspi5 computer board has improved CPU and I/O capabilities.",
    "The future of AI is in Deep Learning, with its wide use cases.",
    "Being great requires dedication and hard work.",
    "The sport dart requires focus and accuracy.",
    "A new startup is developing AI-powered tools for creative professionals.",
    "Apple's latest iPhone features an advanced camera system and OLED display.",
]
